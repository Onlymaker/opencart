...
$_['entry_text_card_name']				= 'Name on Card: <div class="help-text">HTML is supported.</div>';
$_['entry_text_card_number']			= 'Card Number: <div class="help-text">HTML is supported.</div>';
$_['entry_text_card_type']				= 'Card Type: <div class="help-text">HTML is supported.</div>';
...
$_['entry_cards_page_link']				= 'Cards Page Link: <div class="help-text">Enter the link text for the page where customers can view their stored cards, shown on the main account page (if you are using the included vQmod file).</div>';

...
<div id="content"><div class="container-fluid">
	<div class="page-header">
	    <h1>ThemeGlobal Fashionista MegaMenu</h1>
	    <ul class="breadcrumb">
	...
	<?php } ?>
	<div class="set-size" id="tg_fashionista_megamenu">
...
$(document).ready(function() {
	...
	function menu_updatesort(jsonstring) {
		...
		if (mittXHRobjekt) {
			...
			ajaxRequest.open("GET", "index.php?route=extension/module/tg_fashionista_megamenu&token=<?php echo $_GET['token']; ?>&jsonstring=" + jsonstring, true);

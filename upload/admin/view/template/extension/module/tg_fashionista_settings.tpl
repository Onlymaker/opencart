...
<div id="content"><div class="container-fluid">
	<div class="page-header">
	    <h1>ThemeGlobal Fashionista Settings</h1>
	    <ul class="breadcrumb">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=extension/module/tg_fashionista_settings&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
			...
			<div>
				...
				<div class="bg-tabs">
					...
					<div id="tabs" class="htabs2 main-tabs">
						...
						<a href="#tab_footer" id="tfooter"><span>Social & Footer</span></a>
						...
						<div class="footer_right">
							...
							<div id="tab_customfooter_<?php echo $language_id; ?>">
								...
								<div id="tabs_<?php echo $language_id; ?>" class="htabs tabs-design">
									<a href="#tab_facebook_<?php echo $language_id; ?>" class="tfacebook"><span>Social</span></a>
									<a href="#tab_contact_<?php echo $language_id; ?>" class="tcontact"><span>Footer</span></a>
								...
								<div id="tab_facebook_<?php echo $language_id; ?>" class="tab-content4">
									...
									<div class="input">
										...
										<p>Title:</p>
										<?php if(isset($customfooter[$language_id]['social_title'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][social_title]" value="<?php echo $customfooter[$language_id]['social_title']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][social_title]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['facebook_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][facebook_link]" value="<?php echo $customfooter[$language_id]['facebook_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][facebook_link]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['twitter_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][twitter_link]" value="<?php echo $customfooter[$language_id]['twitter_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][twitter_link]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['instagram_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][instagram_link]" value="<?php echo $customfooter[$language_id]['instagram_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][instagram_link]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['googleplus_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][googleplus_link]" value="<?php echo $customfooter[$language_id]['googleplus_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][googleplus_link]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['pinterest_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][pinterest_link]" value="<?php echo $customfooter[$language_id]['pinterest_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][pinterest_link]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['youtube_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][youtube_link]" value="<?php echo $customfooter[$language_id]['youtube_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][youtube_link]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['flickr_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][flickr_link]" value="<?php echo $customfooter[$language_id]['flickr_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][flickr_link]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['vimeo_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][vimeo_link]" value="<?php echo $customfooter[$language_id]['vimeo_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][vimeo_link]" value="" />
										<?php } ?>
									...
									<div class="input">
										...
										<p>Link:</p>
										<?php if(isset($customfooter[$language_id]['tumblr_link'])) { ?>
										<input name="customfooter[<?php echo $language_id; ?>][tumblr_link]" value="<?php echo $customfooter[$language_id]['tumblr_link']; ?>" />
										<?php } else { ?>
										<input name="customfooter[<?php echo $language_id; ?>][tumblr_link]" value="" />
										<?php } ?>
					...
					<div id="tab_install_data" class="tab-content">
						...
						<div class="input">
							<p style="width:320px">ThemeGlobal Fashionista Revolution Slider:</p>
							<input type="submit" name="install_tg_fashionista_revolution_slider" class="button-install" onclick="return confirm('Are you sure you want to install sample data?')" value="">
							
							<div class="clear"></div>
						</div>
						
						<div class="input">
							<p style="width:320px">ThemeGlobal Fashionista MegaMenu:</p>
							<input type="submit" name="install_tg_fashionista_megamenu" class="button-install" onclick="return confirm('Are you sure you want to install sample data?')" value="">
							
							<div class="clear"></div>
						</div>
						
						<div class="input">
							<p style="width:320px">ThemeGlobal Fashionista Filter Product:</p>
							<input type="submit" name="install_tg_fashionista_filter_product" class="button-install" onclick="return confirm('Are you sure you want to install sample data?')" value="">

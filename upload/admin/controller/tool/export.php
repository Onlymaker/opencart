...
class ControllerToolExport extends Controller { 
	...
	public function index() {		
		...
		$data['stock_statuss'] = $this->model_localisation_stock_status->getStockStatuses();
		/////////// Stores
		...
		$this->response->setOutput($this->load->view('tool/export', $data));
	}

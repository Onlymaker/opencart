<?php
class ControllerFBStoreFBCheckoutPaymentAddress extends Controller {
...
$this->load->model('fbstore/fbstore');
		...
		$this->response->setOutput($this->model_fbstore_fbstore->getOutput('fbstore/fbcheckout/payment_address', $data));
	}

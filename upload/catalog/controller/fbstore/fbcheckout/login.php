<?php
class ControllerFBStoreFBCheckoutLogin extends Controller {
...
$this->load->model('fbstore/fbstore');
		...
		$data['forgotten'] = $this->model_fbstore_fbstore->link('fbstore/fbcheckout/forgotten', '', true);

		$this->response->setOutput($this->model_fbstore_fbstore->getOutput('fbstore/fbcheckout/login', $data));
	}

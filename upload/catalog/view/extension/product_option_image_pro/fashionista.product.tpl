<script type="text/javascript"><!--
	// 2017/03/21 (copied from Fastor and modified)
	...
	poip_product_custom.prototype.custom_refreshPopup = function(){
		...
		if ( $('#quickview_product .popup-gallery .thumbnails').length && !$('#quickview_product .popup-gallery .thumbnails').closest('#quickview').length ) {
		
			$('#poip_popup').remove();
			$('#quickview_product').before('<div id="poip_popup" style="display:none;"></div>');
			
			var added_imgs = [];
			$('#quickview_product .popup-gallery .thumbnails a[data-poip-visible]').each(function(){
			...
			$('#quickview_product .popup-gallery .thumbnails a, #ex1').off('click');
			$('#quickview_product .popup-gallery .thumbnails a, #ex1').on('click', function(e){

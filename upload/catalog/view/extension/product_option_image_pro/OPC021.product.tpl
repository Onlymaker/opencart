<script type="text/javascript"><!--
	// Modern - Opencart Multi Purpose Responsive Theme by TemplateTrip // 2017/01/19
	...
	poip_product_custom.prototype.replace_setVisibleImages = function(images, counter) {
		...
		var carousel_selector = '.additional-images';
		...
		if ( carousel_elem.length ) {
			...
			for (var i in images) {
				...
				if (elem.length) {
					...
					current_carousel.addItem('<div class="image-additional">'+ this_object.getElementOuterHTML(elem.parent()) + '</div>');
				}
			}
			// new owlCarousel version
	...
	poip_product_custom.prototype.if_getMainImage = function() {
		...
		return $('.product-image a.thumbnail img:first');
	}

...
INSERT INTO `oc_modification` VALUES (1,'Facebook Login','ocxfbl160','OC-Extensions.com','1.6.0','http://www.oc-extensions.com/Facebook-Login','<?xml version=\"1.0\" encoding=\"utf-8\"?>\r\n<modification>\r\n	<name>Facebook Login</name>\r\n	<version>1.6.0</version>\r\n	<code>ocxfbl160</code>\r\n	<author>OC-Extensions.com</author>\r\n	<link>http://www.oc-extensions.com/Facebook-Login</link>\r\n\r\n	<file path=\"catalog/controller/common/header.php\">\r\n		<operation error=\"log\">\r\n			<search><![CDATA[$data[\'title\'] = $this->document->getTitle();]]></search>\r\n			<add position=\"after\"><![CDATA[ \r\n			$this->document->addScript(\'catalog/view/javascript/jquery/jquery.fblogin.js\'); \r\n			$this->document->addScript(\'catalog/view/javascript/jquery/datetimepicker/moment.js\');\r\n			$this->document->addScript(\'catalog/view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.js\');\r\n			$this->document->addStyle(\'catalog/view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.css\');\r\n\r\n			\r\n			if (file_exists(\'catalog/view/theme/\' . $this->config->get($this->config->get(\'config_theme\') . \'_directory\') . \'/stylesheet/fb_login.css\')) {\r\n				$this->document->addStyle(\'catalog/view/theme/\' . $this->config->get($this->config->get(\'config_theme\') . \'_directory\') . \'/stylesheet/fb_login.css\');\r\n			} else {\r\n				$this->document->addStyle(\'catalog/view/theme/default/stylesheet/fb_login.css\');\r\n			}\r\n			]]></add>\r\n		</operation>\r\n		<operation error=\"log\">\r\n			<search><![CDATA[$this->load->language(\'common/header\');]]></search>\r\n			<add position=\"before\"><![CDATA[\r\n			$data[\'fb_login_app_id\'] = $this->config->get(\'fb_login_app_id\');\r\n			]]></add>\r\n		</operation>\r\n	</file>\r\n	\r\n	<file path=\"catalog/view/theme/*/template/common/header.tpl\">\r\n		<operation error=\"log\">\r\n			<search><![CDATA[</head>]]></search>\r\n			<add position=\"before\"><![CDATA[\r\n			<script type=\"text/javascript\"><!--\r\n			window.fbAsyncInit = function() {\r\n				FB.init({\r\n					appId      : \'<?php echo $fb_login_app_id; ?>\', // App ID\r\n					status     : true, // check login status\r\n					cookie     : true, // enable cookies to allow the server to access the session\r\n					xfbml      : true  // parse XFBML\r\n				});\r\n			};\r\n\r\n			// Load the SDK Asynchronously\r\n			(function(d){\r\n				var js, id = \'facebook-jssdk\'; if (d.getElementById(id)) {return;}\r\n				js = d.createElement(\'script\'); js.id = id; js.async = true;\r\n				js.src = \"//connect.facebook.net/en_US/all.js\";\r\n				d.getElementsByTagName(\'head\')[0].appendChild(js);\r\n			}(document));\r\n			//--></script>\r\n			]]></add>\r\n		</operation>\r\n	</file>\r\n	\r\n</modification>',1,now());

INSERT INTO `oc_modification` VALUES (2,'FBStore by iSenseLabs','isenselabs_fbstore','iSenseLabs','2.5','http://isenselabs.com','<modification>\r\n	<name>FBStore by iSenseLabs</name>\r\n	<version>2.5</version>\r\n	<link>http://isenselabs.com</link>\r\n	<author>iSenseLabs</author>\r\n	<code>isenselabs_fbstore</code>\r\n\r\n	<file path=\"catalog/controller/common/header.php\">\r\n		<operation>\r\n			<search><![CDATA[public function index() {]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				if(isset($_SESSION[\'fbstore_checkout\'])){\r\n            		unset($_SESSION[\'fbstore_checkout\']);\r\n        		}\r\n		]]></add>\r\n		</operation>\r\n	</file>\r\n\r\n	<file path=\"system/library/url.php\">\r\n		<operation>\r\n			<search><![CDATA[if ($args) {]]></search>\r\n			<add position=\"before\"><![CDATA[\r\n				//Isenselabs FBStore\r\n				if(isset($_SESSION[\'fbstore_checkout\'])){\r\n					$url = \'https://\' . $_SERVER[\'HTTP_HOST\'] . rtrim(dirname($_SERVER[\'SCRIPT_NAME\']), \'/.\\\\\') . \'/index.php?route=\' . $route;\r\n					if(substr($route, 0, strlen(\'checkout/\')) === \'checkout/\') $route = str_replace(\'checkout/\' ,\'fbstore/fbcheckout/\', $route);\r\n				}\r\n				// END Isenselabs FBStore\r\n		]]></add>\r\n		</operation>\r\n	</file>\r\n\r\n	<file path=\"admin/controller/extension/module.php\">\r\n		<operation>\r\n			<search><![CDATA[if (isset($this->request->get[\'module_id\']) && $this->validateDelete()) {]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				//Isenselabs FBStore\r\n					$this->load->model(\'module/fbstore\');\r\n					$this->model_module_fbstore->deleteStoreTab($this->request->get[\'module_id\']);\r\n				// END Isenselabs FBStore\r\n		]]></add>\r\n		</operation>\r\n	</file>\r\n</modification>\r\n\r\n',0,now());

INSERT INTO `oc_modification` VALUES (3,'TMD Import Export  Module','#OXIOM-2.2.0.0','TMD(opencartextensions.in)','2.2.0.0-2.3.0.0','http://opencartextensions.in/','<modification>\r\n	<name>TMD Import Export  Module</name>\r\n	<version>2.2.0.0-2.3.0.0</version>\r\n	<code>#OXIOM-2.2.0.0</code>\r\n	<author>TMD(opencartextensions.in)</author>\r\n	<link>http://opencartextensions.in/</link>\r\n	<file path=\"admin/language/*/common/menu.php\">\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[$_[\'text_affiliate\']                   = \'Affiliates\';]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n			///////// TMD IMport MODULE \r\n			$_[\'text_import\']                   = \'TMD Import Excel File\';\r\n			///////// TMD IMport MODULE \r\n			]]></add>\r\n		</operation>\r\n	</file>\r\n	<file path=\"admin/view/template/common/menu.tpl\">\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[<li><a class=\"parent\"><?php echo $text_localisation; ?></a>]]></search>\r\n			<add position=\"before\"><![CDATA[<li><a href=\"<?php echo $import; ?>\"><?php echo $text_import; ?></a></li>]]></add>\r\n		</operation>\r\n	</file>\r\n	<file path=\"admin/controller/common/menu.php\">\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[$data[\'text_affiliate\'] = $this->language->get(\'text_affiliate\');]]></search>\r\n			<add position=\"before\"><![CDATA[$data[\'text_import\'] = $this->language->get(\'text_import\');]]></add>\r\n		</operation>\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[$data[\'attribute\'] = $this->url->link(\'catalog/attribute\', \'token=\' . $this->session->data[\'token\'], true);]]></search>\r\n			<add position=\"before\"><![CDATA[$data[\'import\'] = $this->url->link(\'tool/import\', \'token=\' . $this->session->data[\'token\'], true);]]></add>\r\n		</operation>\r\n	</file>\r\n	<file path=\"admin/language/*/common/column_left.php\">\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[// Text]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				$_[\'text_import\']                   = \'TMD Import Excel File\';\r\n			$_[\'text_export1\']                   = \'TMD Export Excel File\';\r\n			]]></add>\r\n		</operation>\r\n	</file>\r\n	\r\n	<file path=\"admin/controller/common/column_left.php\">\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[$localisation = array();]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				if ($this->user->hasPermission(\'access\', \'tool/import\')) {\r\n				$system[] = array(\r\n					\'name\'	   => $this->language->get(\'text_import\'),\r\n					\'href\'     => $this->url->link(\'tool/import\', \'token=\' . $this->session->data[\'token\'], true),\r\n					\'children\' => array()		\r\n				);	\r\n				}\r\n			\r\n				\r\n				if ($this->user->hasPermission(\'access\', \'tool/export\')) {\r\n					$system[] = array(\r\n						\'name\'	   => $this->language->get(\'text_export1\'),\r\n						\'href\'     => $this->url->link(\'tool/export\', \'token=\' . $this->session->data[\'token\'], true),\r\n						\'children\' => array()		\r\n					);	\r\n				}\r\n			]]></add>\r\n		</operation>\r\n	</file>\r\n	<file path=\"admin/language/*/common/menu.php\">\r\n		<operation>\r\n			<search><![CDATA[// Text]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n			///////// TMD IMport MODULE \r\n			$_[\'text_export\']                   = \'TMD Export Excel File\';\r\n			///////// TMD IMport MODULE \r\n			]]></add>\r\n		</operation>\r\n	</file>\r\n	<file path=\"admin/view/template/common/menu.tpl\">\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[<li><a class=\"parent\"><?php echo $text_localisation; ?></a>]]></search>\r\n			<add position=\"before\"><![CDATA[<li><a href=\"<?php echo $export; ?>\"><?php echo $text_export; ?></a></li>]]></add>\r\n		</operation>\r\n	</file>\r\n	<file path=\"admin/controller/common/menu.php\">\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[$data[\'text_affiliate\'] = $this->language->get(\'text_affiliate\');]]></search>\r\n			<add position=\"before\"><![CDATA[$data[\'text_export\'] = $this->language->get(\'text_export\');]]></add>\r\n		</operation>\r\n		<operation error=\"skip\">\r\n			<search><![CDATA[$data[\'attribute\'] = $this->url->link(\'catalog/attribute\', \'token=\' . $this->session->data[\'token\'], true);]]></search>\r\n			<add position=\"after\"><![CDATA[$data[\'export\'] = $this->url->link(\'tool/export\', \'token=\' . $this->session->data[\'token\'], true);]]></add>\r\n		</operation>\r\n	</file>\r\n	<file path=\"admin/view/template/catalog/product_list.tpl\">\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php if ($sort == \'pd.name\') { ?>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n					<td class=\"text-left\">Product Id</td>\r\n					<!--xml-->]]></add>\r\n		</operation>\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php echo $product[\'name\']; ?></td>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n			  <td class=\"text-left\"><?php echo $product[\'product_id\']; ?></td>\r\n			  <!--xml-->]]></add>\r\n		</operation>\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-center\" colspan=\"8\"><?php echo $text_no_results; ?></td>]]></search>\r\n			<add position=\"replace\"><![CDATA[<td class=\"text-center\" colspan=\"9\"><?php echo $text_no_results; ?></td>]]></add>\r\n		</operation>\r\n	</file>\r\n	<file path=\"admin/view/template/catalog/category_list.tpl\">\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php if ($sort == \'name\') { ?>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n					<td class=\"text-left\">Category Id</td>\r\n					<!--xml-->]]></add>\r\n		</operation>\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php echo $category[\'name\']; ?></td>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n				  <td class=\"text-left\"><?php echo $category[\'category_id\']; ?></td><!--xml-->]]></add>\r\n		</operation>\r\n	</file>\r\n	\r\n	<file path=\"admin/view/template/catalog/manufacturer_list.tpl\">\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php if ($sort == \'name\') { ?>]]></search>\r\n			<add position=\"before\"><![CDATA[ <!--xml-->\r\n			<td class=\"text-left\">Manufacturer Id</td>\r\n			<!--xml-->]]></add>\r\n		</operation>\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php echo $manufacturer[\'name\']; ?></td>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n				  <td class=\"text-left\"><?php echo $manufacturer[\'manufacturer_id\']; ?></td>\r\n				  <!--xml-->]]></add>\r\n		</operation>\r\n	</file>\r\n	\r\n	<file path=\"admin/view/template/catalog/information_list.tpl\">\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php if ($sort == \'id.title\') { ?>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n				<td class=\"text-left\">Information Id</td>\r\n				<!--xml-->]]></add>\r\n		</operation>\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php echo $information[\'title\']; ?></td>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n				  <td class=\"text-left\"><?php echo $information[\'information_id\']; ?></td>\r\n				  <!--xml-->]]></add>\r\n		</operation>\r\n	</file>\r\n	\r\n		\r\n	<file path=\"admin/view/template/catalog/download_list.tpl\">\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php if ($sort == \'dd.name\') { ?>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n				<td class=\"text-left\">Download Id</td>\r\n				<!--xml-->]]></add>\r\n		</operation>\r\n		<operation error=\"log\">\r\n			<search><![CDATA[<td class=\"text-left\"><?php echo $download[\'name\']; ?></td>]]></search>\r\n			<add position=\"before\"><![CDATA[<!--xml-->\r\n				  <td class=\"text-left\"><?php echo $download[\'download_id\']; ?></td>\r\n				  <!--xml-->]]></add>\r\n		</operation>\r\n	</file>\r\n</modification>',1,now());

INSERT INTO `oc_modification` VALUES (4,'VIP Customer Discount','vip_customer','Tri Le','4.1.6','http://tlecode.com/','<?xml version=\"1.0\" encoding=\"utf-8\"?>\n<modification>\n  <name>VIP Customer Discount</name>\n  <code>vip_customer</code>\n  <version>4.1.6</version>\n  <link>http://tlecode.com/</link>\n  <author>Tri Le</author>\n\n  <file path=\"catalog/controller/{extension/module,product}/*.php\">\n    <operation>\n      <search regex=\"true\"><![CDATA[~(.*data..products..\\[.*\\].*)~]]></search>\n      <add position=\"replace\"><![CDATA[\n//tri mod start\n$this->load->language(\'extension/module/vip_customer\');\n\n$vip = new vip_customer($this->registry);\n$vip_customer = $vip->getVip($this->customer->getId());\n\nif (!$this->config->get(\'vip_customer_hide_price\') && !empty($vip_customer[\'discount\']) && (!$special || ($special && $this->config->get(\'vip_customer_special_product\')))) {\n  if (isset($result)) $vip_product = $result;\n  elseif (isset($product)) $vip_product = $product;\n  elseif (isset($product_info)) $vip_product = $product_info;\n  else $this->log->write(\'vip_product \' . __CLASS__ . \' \' . __FUNCTION__ . \' no product info!\');\n\n  if (isset($vip_product)) {\n    if ($special && $this->config->get(\'vip_customer_special_product\')) {\n      $vip_product[\'price\'] = $vip_product[\'special\'];\n    }\n\n    $vip_price_ex_tax = $vip_product[\'price\'] * (1 - $vip_customer[\'discount\'] / 100);\n    $vip_price = $this->currency->format($this->tax->calculate($vip_price_ex_tax, $vip_product[\'tax_class_id\'], $this->config->get(\'config_tax\')), $this->session->data[\'currency\']);\n\n   $price = $this->currency->format($this->tax->calculate($vip_product[\'price\'], $vip_product[\'tax_class_id\'], $this->config->get(\'config_tax\')), $this->session->data[\'currency\']);\n\n   $special = $this->language->get(\'text_vip_price\') . \': \' . $vip_price;\n\n   if ($tax) $tax = $this->currency->format($vip_price_ex_tax, $this->session->data[\'currency\']);\n  }\n}\n//tri mod end\n$1\n      ]]></add>\n    </operation>\n  </file>\n\n  <file path=\"catalog/controller/product/product.php\">\n    <operation>\n      <search><![CDATA[updateViewed]]></search>\n      <add position=\"after\"><![CDATA[\n//tri mod start\n$data[\'lng\'] = $this->load->language(\'extension/module/vip_customer\');\n\n$vip = new vip_customer($this->registry);\n$vip_customer = $vip->getVip($this->customer->getId());\n\nif (isset($product_info)) $vip_product = $product_info;\nelse $this->log->write(\'vip_product \' . __FUNCTION__ . \' no product info!\');\n\nif (!$this->config->get(\'vip_customer_hide_price\') && !empty($vip_customer[\'discount\']) && (!$data[\'special\'] || ($data[\'special\'] && $this->config->get(\'vip_customer_special_product\')))) {\n  if (isset($vip_product)) {\n    if ($data[\'special\'] && $this->config->get(\'vip_customer_special_product\')) {\n      $vip_product[\'price\'] = $vip_product[\'special\'];\n    }\n\n    $vip_price_ex_tax = $vip_product[\'price\'] * (1 - $vip_customer[\'discount\'] / 100);\n    $vip_price = $this->currency->format($this->tax->calculate($vip_price_ex_tax, $vip_product[\'tax_class_id\'], $this->config->get(\'config_tax\')), $this->session->data[\'currency\']);\n\n    $data[\'price\'] = $this->currency->format($this->tax->calculate($vip_product[\'price\'], $vip_product[\'tax_class_id\'], $this->config->get(\'config_tax\')), $this->session->data[\'currency\']);\n\n    $data[\'special\'] = $this->language->get(\'text_vip_price\') . \': \' . $vip_price;\n\n   if ($data[\'tax\']) $data[\'tax\'] = $this->currency->format($vip_price_ex_tax, $this->session->data[\'currency\']);\n  }\n}\n\nif ($this->config->get(\'vip_customer_show_vip_price_table\')) {\n  $data[\'show_price\'] = $this->config->get(\'vip_customer_price_table_format\') == \'price\' ? 1 : 0;\n\n  foreach ($vip->getLevels() as $r) {\n    $data[\'vip_prices\'][$r[\'vip_id\']] = array(\n      \'vip_level\' => $r[\'name\'][$this->config->get(\'config_language_id\')],\n      \'discount\' => $r[\'discount\'],\n      \'price\' => $this->currency->format($this->tax->calculate($vip_product[\'price\'] * (1 - $r[\'discount\'] / 100), $vip_product[\'tax_class_id\'], $this->config->get(\'config_tax\')), $this->session->data[\'currency\'])\n    );\n  }\n\n  if (version_compare(VERSION, \'2.2\') >= 0) {\n    $data[\'vip_price_table\'] = $this->load->view(\'extension/module/vip_customer_price_table\', $data);\n  } else {\n    if (file_exists(DIR_TEMPLATE . $this->config->get(\'config_template\') . \'/template/extension/module/vip_customer_price_table.tpl\')) {\n      $data[\'vip_price_table\'] = $this->load->view($this->config->get(\'config_template\') . \'/template/extension/module/vip_customer_price_table.tpl\', $data);\n    } else {\n      $data[\'vip_price_table\'] = $this->load->view(\'default/template/extension/module/vip_customer_price_table.tpl\', $data);\n    }\n  }\n}\n//tri mod end\n      ]]></add>\n    </operation>\n  </file>\n\n  <file path=\"catalog/view/theme/*/template/product/product.tpl\">\n    <operation>\n      <search><![CDATA[echo $footer]]></search>\n      <add position=\"before\"><![CDATA[\n<?php if (isset($vip_price_table)) echo $vip_price_table; ?><!--tri mod-->\n      ]]></add>\n    </operation>\n  </file>\n\n</modification>\n',1,now());

INSERT INTO `oc_modification` VALUES (5,'<font color=\"#0000\"><b>Exit Bee Popup</font>','ExitBee','<font color=\"#CC0000\"><b>Exit Bee</font>','<b>1.0</b>','','<modification>\n   <name><![CDATA[<font color=\"#0000\"><b>Exit Bee Popup</font>]]></name>\n   <code>ExitBee</code>\n    <version><![CDATA[<b>1.0</b>]]></version>\n    <author><![CDATA[<font color=\"#CC0000\"><b>Exit Bee</font>]]></author>\n    <file path=\"catalog/controller/common/footer.php\">\n      <operation error=\"skip\">\n			<search><![CDATA[\n	          $data[\'newsletter\'] = $this->url->link(\'account/newsletter\', \'\', true);\n			]]></search>\n			<add position=\"after\"><![CDATA[\n            $data[\'exitbee_site_key\'] = html_entity_decode($this->config->get(\'exitbee_site_key\'));\n            $data[\'exitbee_status\'] = $this->config->get(\'exitbee_status\');\n\n			]]></add>\n    </operation>\n  </file>\n  <file path=\"catalog/controller/checkout/success.php\">\n    <operation error=\"skip\">\n    <search><![CDATA[\n          if (isset($this->session->data[\'order_id\'])) {\n    ]]></search>\n    <add position=\"after\"><![CDATA[\n          $data[\'exitbee_status\'] = $this->config->get(\'exitbee_status\');\n          $data[\'exitbee_ecommerce_status\'] = $this->config->get(\'exitbee_ecommerce_status\');\n          //get order data\n          $this->load->model(\'account/order\');\n          $this->load->model(\'catalog/product\');\n          $this->load->model(\'catalog/category\');\n\n          $exitbee_order_id = $this->session->data[\'order_id\'];\n          $order = $this->model_account_order->getOrder($exitbee_order_id);\n          $orderItems = $this->model_account_order->getOrderProducts($exitbee_order_id);\n\n          $exitbee_order = array();\n          $exitbee_order[\'customer_last_name\'] = $order[\'lastname\'];\n          $exitbee_order[\'customer_first_name\'] = $order[\'firstname\'];\n          $exitbee_order[\'customer_email\'] = $order[\'email\'];\n          $exitbee_order[\'total\'] = $order[\'total\'];\n          $exitbee_order[\'currency\'] = $order[\'currency_code\'];\n          $exitbee_order[\'platform\'] = \'opencart\';\n          $exitbee_order[\'oid\'] = $exitbee_order_id;\n          $exitbee_order[\'suid\'] = $order[\'customer_id\'];\n          $exitbee_order[\'billing_address\'] = $order[\'payment_address_1\'] . \' \' .\n            $order[\'payment_city\'] . \' \' . $order[\'payment_postcode\'] . \' \' .\n            $order[\'payment_zone\'] . \' \' . $order[\'payment_country\'];\n\n          $exitbee_products = [];\n          foreach ($orderItems as $item) {\n            $product_id = $item[\'product_id\'];\n            $product = $this->model_catalog_product->getProduct($product_id);\n\n            $productCategories = $this->model_catalog_product->getCategories($product_id);\n            $productCategoryId = isset($productCategories[0]) ? $productCategories[0][\'category_id\'] : null;\n            $productCategoryName = isset($productCategoryId) ? $this->model_catalog_category->getCategory($productCategoryId)[\'name\'] : \'\';\n\n            $productUrl = $this->url->link(\'product/product\', \'product_id=\' . $product_id);\n            $productUrl = str_replace(array(\'&amp;\', \"\\n\", \"\\r\"), array(\'&\', \'\', \'\'), $productUrl); //see system\'s redirect function\n\n            $exitbee_products[] = [\n              \'name\' => $item[\'name\'],\n              \'sku\' => $product[\'sku\'],\n              \'quantity\' => (int) $item[\'quantity\'],\n              \'price\' => (float) $item[\'price\'],\n              \'category\' => $productCategoryName,\n              \'url\' => $productUrl,\n            ];\n          }\n          $exitbee_order[\'products\'] = $exitbee_products;\n\n          $data[\'order_json\'] = json_encode($exitbee_order);\n\n\n    ]]></add>\n  </operation>\n</file>\n  <file path=\"catalog/view/theme/*/template/common/footer.tpl\">\n  <operation error=\"skip\">\n  			<search><![CDATA[\n          </body>\n  			]]></search>\n  			<add position=\"before\"><![CDATA[\n  		      <?php if($exitbee_status) {\n            echo\n              \'<script>\n                (function(doc) {\n                  var xtb = document.createElement(\"script\");\n                  xtb.type = \"text/javascript\";\n                  xtb.async = true;\n                  xtb.src = document.location.protocol + \"//app.exitbee.com/c/\'.$exitbee_site_key.\'/exitbee.js\";\n                  document.getElementsByTagName(\"head\")[0].appendChild(xtb);\n                }())\n              </script>\';\n             }\n             ?>\n  			]]></add>\n  </operation>\n  </file>\n\n  <file path=\"catalog/view/theme/*/template/common/success.tpl\">\n  <operation error=\"skip\">\n  			<search><![CDATA[\n          <div class=\"container\">\n  			]]></search>\n  			<add position=\"after\"><![CDATA[\n  		      <?php if(isset($exitbee_ecommerce_status) && $exitbee_ecommerce_status && isset($exitbee_status) && $exitbee_status) {\n                echo \'<script>\';\n                  echo  \'window.eb=window.eb||function(){(eb.q=eb.q||[]).push(arguments)};\';\n                  echo \'var orderJson = JSON.parse(\\\'\'.$order_json.\'\\\');\';\n                  echo \'eb(\"pushOrder\", orderJson);\';\n                echo \'</script>\';\n             }\n             ?>\n  			]]></add>\n  </operation>\n  </file>\n</modification>\n',1,now());
